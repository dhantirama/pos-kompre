...
<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
  <div class="app-brand demo">
    <a href="../admin/index.php" class="app-brand-link">
      ...
      <span class="app-brand-text demo menu-text fw-bolder ms-2">Sukacita</span>
    </a>
        ...
        <ul class="menu-sub">
          ...
          <li class="menu-item">
            <a href="pelanggan.php" class="menu-link">
              <div data-i18n="Without navbar">Pelanggan</div>
            </a>
          </li>
          <li class="menu-item">
            <a href="paket.php" class="menu-link">
              <div data-i18n="Container">Paket</div>
            </a>
          </li>
        </ul>
      </li>
    ...
    <?php if ($_SESSION['id_level'] == 1 or $_SESSION['id_level'] == 2): ?>
      <li class="menu-item">
        <a href="javascript:void(0);" class="menu-link menu-toggle">
          ...
          <div data-i18n="Account Settings">Orderan</div>
        </a>
        <ul class="menu-sub">
          <li class="menu-item">
            <a href="order-masuk.php" class="menu-link">
              <div data-i18n="Notifications">Orderan Masuk</div>
            </a>
          </li>
          <li class="menu-item">
            <a href="pickup.php" class="menu-link">
              <div data-i18n="Account">Orderan Selesai</div>
            </a>
          </li>
        </ul>
      </li>
    <?php endif ?>
    <?php if ($_SESSION['id_level'] == 1 or $_SESSION['id_level'] == 4): ?>
      <li class="menu-item">
        <a href="javascript:void(0);" class="menu-link menu-toggle">
        ...
        <ul class="menu-sub">
          <li class="menu-item">
            <a href="laporan.php" class="menu-link" target="_blank">
